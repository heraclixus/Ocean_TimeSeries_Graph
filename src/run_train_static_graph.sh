...
# for model in {fgnn,}; do
#     for window in {6,}; do
#         CUDA_VISIBLE_DEVICES=7 nohup python run_pygtemporal_models.py --n_pcs=5 --use_loss_weights --use_normalization --model_name=$model --batch_size=32 --window=$window &> logs_report_5/log_${model}_weighted_32_${window}.txt &
#         CUDA_VISIBLE_DEVICES=7 nohup python run_pygtemporal_models.py --n_pcs=5 --use_loss_weights --use_normalization --model_name=$model --batch_size=64 --window=$window &> logs_report_5/log_${model}_weighted_64_${window}.txt &
#         CUDA_VISIBLE_DEVICES=7 nohup python run_pygtemporal_models.py --n_pcs=5 --use_loss_weights --use_normalization --model_name=$model --batch_size=96 --window=$window &> logs_report_5/log_${model}_weighted_96_${window}.txt &

#         CUDA_VISIBLE_DEVICES=7 nohup python run_pygtemporal_models.py --n_pcs=20 --use_loss_weights --use_normalization --model_name=$model --batch_size=32 --window=$window &> logs_report/log_${model}_weighted_32_${window}.txt &
#         CUDA_VISIBLE_DEVICES=7 nohup python run_pygtemporal_models.py --n_pcs=20 --use_loss_weights --use_normalization --model_name=$model --batch_size=64 --window=$window &> logs_report/log_${model}_weighted_64_${window}.txt &
#         CUDA_VISIBLE_DEVICES=7 nohup python run_pygtemporal_models.py --n_pcs=20 --use_loss_weights --use_normalization --model_name=$model --batch_size=96 --window=$window &> logs_report/log_${model}_weighted_96_${window}.txt &        

#         CUDA_VISIBLE_DEVICES=7 nohup python run_pygtemporal_models.py --n_pcs=5 --use_cosine --use_loss_weights --use_normalization --model_name=$model --batch_size=32 --window=$window &> logs_report_5/log_${model}_weighted_32_${window}_cosine.txt &
#         CUDA_VISIBLE_DEVICES=7 nohup python run_pygtemporal_models.py --n_pcs=5 --use_cosine --use_loss_weights --use_normalization --model_name=$model --batch_size=64 --window=$window &> logs_report_5/log_${model}_weighted_64_${window}_cosine.txt &
#         CUDA_VISIBLE_DEVICES=7 nohup python run_pygtemporal_models.py --n_pcs=5 --use_cosine --use_loss_weights --use_normalization --model_name=$model --batch_size=96 --window=$window &> logs_report_5/log_${model}_weighted_96_${window}_cosine.txt &

#         CUDA_VISIBLE_DEVICES=7 nohup python run_pygtemporal_models.py --n_pcs=20 --use_cosine --use_loss_weights --use_normalization --model_name=$model --batch_size=32 --window=$window &> logs_report/log_${model}_weighted_32_${window}_cosine.txt &
#         CUDA_VISIBLE_DEVICES=7 nohup python run_pygtemporal_models.py --n_pcs=20 --use_cosine --use_loss_weights --use_normalization --model_name=$model --batch_size=64 --window=$window &> logs_report/log_${model}_weighted_64_${window}_cosine.txt &
#         CUDA_VISIBLE_DEVICES=7 nohup python run_pygtemporal_models.py --n_pcs=20 --use_cosine --use_loss_weights --use_normalization --model_name=$model --batch_size=96 --window=$window &> logs_report/log_${model}_weighted_96_${window}_cosine.txt &

#         CUDA_VISIBLE_DEVICES=7 nohup python run_pygtemporal_models.py --n_pcs=5 --use_cosine --use_warmup --use_loss_weights --use_normalization --model_name=$model --batch_size=32 --window=$window &> logs_report_5/log_${model}_weighted_32_${window}_cosine_warmup.txt &
#         CUDA_VISIBLE_DEVICES=7 nohup python run_pygtemporal_models.py --n_pcs=5 --use_cosine --use_warmup --use_loss_weights --use_normalization --model_name=$model --batch_size=64 --window=$window &> logs_report_5/log_${model}_weighted_64_${window}_cosine_warmup.txt &
#         CUDA_VISIBLE_DEVICES=7 nohup python run_pygtemporal_models.py --n_pcs=5 --use_cosine --use_warmup --use_loss_weights --use_normalization --model_name=$model --batch_size=96 --window=$window &> logs_report_5/log_${model}_weighted_96_${window}_cosine_warmup.txt &

#         CUDA_VISIBLE_DEVICES=7 nohup python run_pygtemporal_models.py --n_pcs=20 --use_cosine --use_warmup --use_loss_weights --use_normalization --model_name=$model --batch_size=32 --window=$window &> logs_report/log_${model}_weighted_32_${window}_cosine_warmup.txt &
#         CUDA_VISIBLE_DEVICES=7 nohup python run_pygtemporal_models.py --n_pcs=20 --use_cosine --use_warmup --use_loss_weights --use_normalization --model_name=$model --batch_size=64 --window=$window &> logs_report/log_${model}_weighted_64_${window}_cosine_warmup.txt &
#         CUDA_VISIBLE_DEVICES=7 nohup python run_pygtemporal_models.py --n_pcs=20 --use_cosine --use_warmup --use_loss_weights --use_normalization --model_name=$model --batch_size=96 --window=$window &> logs_report/log_${model}_weighted_96_${window}_cosine_warmup.txt &

#     done
# done


CUDA_VISIBLE_DEVICES=3 nohup python run_pygtemporal_models.py --model_name=agcrn --use_normalization --use_loss_weights --batch_size=32 --window=4 --use_cosine &> logs_report/log_agcrn_weighted_32_4_cosine.txt &
